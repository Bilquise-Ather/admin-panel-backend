...
let GalleryManager = require('../managers/gallery');
 ...
 *                   type: string
*/
let getAllGallery = (req, res, next) => {
    return GalleryManager
        .getAllGallery(req.body)
        .then(data => {
            let result = {
                status: 200,
                data: data
 ...
 *                   type: string
*/
let updateGallery = (req, res, next) => {
    return GalleryManager
        .updateGallery(req)
        .then(data => {
            let result = {
 ...
 *                   type: string
*/
let deleteGallery = (req, res, next) => {
    return GalleryManager
        .deleteGallery(req.params.slider_id)
        .then(data => {
            let result = {
                status: 200,
                data: data
 ...
 *                   type: string
*/
let getAllGalleryForWebsite = (req, res, next) => {
    return GalleryManager
