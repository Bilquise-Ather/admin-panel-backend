...
let sliderManager = require('../managers/rooms_path');

/**
 * @swagger
 * /api/rooms_path/add_slider:
 *   post:
...
/**
 * @swagger
 * /api/rooms_path/update_slider/{slider_id}:
 *   put:
...
/**
 * @swagger
 * /api/rooms_path/remove_slide/{slider_id}:
 *   delete:
